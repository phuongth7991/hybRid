...
<div <?= $options['wrapperAttrs'] ?> >
    ...
    <?php if ($showField): ?>
        ...
        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{asset('/assets/media/svg/avatars/blank.svg')}}')">
            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{($options['value']) ? SystemHelper::asset($options['value']) : asset('/assets/media/svg/avatars/blank.svg')}}"></div>
            <!--begin::Edit button-->
