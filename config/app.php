...
return [
    'cdn_url' => env('CDN_URL', 'https://quanlyshop.hn.ss.bfcplatform.vn/public/'),
    ...
    */
    ...
    'aliases' => Facade::defaultAliases()
                       ->merge([
                                   'Page'         => App\Facades\PageFacade::class,
                                   'Menu'         => App\Facades\MenuFacade::class,
                                   'FormBuilder'  => Kris\LaravelFormBuilder\Facades\FormBuilder::class,
                                   'SystemHelper' => App\Facades\SystemHelperFacade::class,
                                   'Excel'        => Maatwebsite\Excel\Facades\Excel::class,
                                   'Image'        => Intervention\Image\Facades\Image::class,
                                   'WebPage'      => App\Facades\WebPageFacade::class,
